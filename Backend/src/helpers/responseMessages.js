...
const POST_LIKED_SUCESSFULLY = 'Post liked successfully'
const POST_UNLIKED_SUCCESSFULLY = 'Post unliked successfully'
...
module.exports = {
  ...
  POST_LIKED_SUCESSFULLY, POST_UNLIKED_SUCCESSFULLY
};